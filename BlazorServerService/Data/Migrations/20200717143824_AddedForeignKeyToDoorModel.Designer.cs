...
namespace BlazorServerService.Data.Migrations
{
    ...
    [Migration("20200717143824_AddedForeignKeyToDoorModel")]
    partial class AddedForeignKeyToDoorModel
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BlazorServerLibrary.Models.ElectricalSafetySelection", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("ElectricalSafetySelection");
                });
            ...
            modelBuilder.Entity("BlazorServerLibrary.Models.Doors.Door", b =>
                {
                    b.HasOne("BlazorServerLibrary.Models.Jobs.Job", null)
                        .WithOne("Door")
                        .HasForeignKey("BlazorServerLibrary.Models.Doors.Door", "JobId")
            ...
            modelBuilder.Entity("BlazorServerLibrary.Models.InvoiceItem", b =>
                {
                    b.HasOne("BlazorServerLibrary.Models.Invoice", null)
